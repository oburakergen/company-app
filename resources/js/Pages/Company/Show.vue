        ...
        <Card v-for="employee in getEmployees">
          <CardContent class="pt-6 flex gap-4 items justify-between">
            ...
            <div class="flex gap-2">
              <ButtonLink :href="route('employee.create')" variant="outline">Add</ButtonLink>
              <ButtonLink :href="route('employee.edit', {'employee': employee.id})" variant="outline">Edit</ButtonLink>
